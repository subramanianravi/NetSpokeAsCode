# Deploying Netskope SASE as Code

Netskope One SASE supports infrastructure-as-code (IaC) and automation via prepackaged OpsLab deployment kits, enabling repeatable, scalable, and policy-integrity-preserving SASE rollouts.
...
## Benefits of IaC for Netskope SASE
...
Netskope SASE can be deployed as code using OpsLab's prepackaged automation kits, enabling repeatable, secure, and scalable SASE rollouts that align with modern DevOps and IaC practices.
